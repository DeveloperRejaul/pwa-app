...
function Main() {
  ...
  return (
    <div className='h-screen overflow-hidden'>
      {/* header part */}
      {route != 'chat' || route != 'knowledge-details' && <p style={{ height: TITLE_HEIGHT }} className='font-bold text-2xl bg-gray-100 text-gray-700 text-center h-10'>{titles[pathname]}</p>}

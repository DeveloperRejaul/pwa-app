...
export default function AdmConsulation() {
    return (
        <div className="mx-10 xl:mx-0 pb-20">
            <div className="flex justify-between items-center pb-4">
                <div className="space-x-9">
                    <button className="font-medium xl:text-2xl underline underline-offset-8">Consultations</button>
                    <button className="font-medium xl:text-[1.19rem] opacity-50">Assigned</button>
                </div>
            ...
            <div className="overflow-auto rounded-3xl no-scrollbar">
                <TblConsultations />
            </div>
        </div>
    )
